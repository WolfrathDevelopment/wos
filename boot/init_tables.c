...
void set_tss(uint esp){

    current_tss.esp0 = esp;
    current_tss.cs   = 0x0b;
    current_tss.ss = current_tss.ds = current_tss.es = current_tss.fs = current_tss.gs = 0x13;
}
